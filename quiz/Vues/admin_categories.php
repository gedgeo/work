    ...
    <body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addCategorieModalLabel">Ajouter un utilisateur</h5>
                    ...
                    <div class="modal-body">
                        <form id="addCategorieForm">
                            ...
                            <div class="mb-3">
                                <label for="nomAdd" class="form-label">Nom de l'utilisateur</label>
        ...
        <div class="modal fade" id="modCategorieModal" tabindex="-1" aria-labelledby="modCategorieModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modCategorieModalLabel">Modifier un utilisateur</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="modCategorieForm">
                            ...
                            <div class="mb-3">
                                <label for="nomMod" class="form-label">Nom de l'utilisateur</label>
        ...
        <div class="modal fade" id="delCategorieModal" tabindex="-1" aria-labelledby="delCategorieModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="delCategorieModalLabel">Supprimer un utilisateur</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
